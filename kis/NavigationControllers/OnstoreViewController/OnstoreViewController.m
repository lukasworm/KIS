...
#import "OnstoreViewController.h"
#import "IntroViewController.h"


@interface OnstoreViewController ()
{
    NSInteger m_countOfPages;
}
@end

@implementation OnstoreViewController
...
- (IntroViewController *)viewControllerAtIndex:(NSUInteger)index {
    ...
    childViewController.strPrefix = @"onstore";
